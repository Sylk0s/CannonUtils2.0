...
public class Main {
    public static void main(String[] args) {
        Explosion explosion = new Explosion(0, 0.061250001192092896, 0, 4.0F);
        TntEntity tntEntity = new TntEntity(new Vec3d(1F/16F, 0.061250001192093, 0), new Vec3d(0, 0, 0));
        ...
        System.out.println(explosion.getVelocityOptimized(tntEntity, 1.0F));
